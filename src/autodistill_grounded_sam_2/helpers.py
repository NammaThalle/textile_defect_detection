...
def load_grounding_dino():
    AUTODISTILL_CACHE_DIR = os.path.expanduser("/app/checkpoints/")

    GROUNDING_DINO_CONFIG_PATH = os.path.join(
        AUTODISTILL_CACHE_DIR, "GroundingDINO_SwinT_OGC.py"
    )
    GROUNDING_DINO_CHECKPOINT_PATH = os.path.join(
        AUTODISTILL_CACHE_DIR, "groundingdino_swint_ogc.pth"
    )
...
def load_SAM():
    ...
    # checkpoint = "/app/checkpoints/sam2_hiera_base_plus.pt"
